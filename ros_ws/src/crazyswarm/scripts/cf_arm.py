...
_CONFIG_CANDIDATES = (
    os.path.join(_SCRIPT_DIR, "..", "launch", "crazyflies.yaml"),
    os.path.join(_SCRIPT_DIR, "..", "..", "share", "crazyswarm", "launch", "crazyflies.yaml"),
)
DEFAULT_CONFIG = next(
    (os.path.abspath(path) for path in _CONFIG_CANDIDATES if os.path.isfile(path)),
    os.path.abspath(_CONFIG_CANDIDATES[0]),
)
