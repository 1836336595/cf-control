...
class MocapState {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('derivatives_valid')) {
        this.derivatives_valid = initObj.derivatives_valid
      }
      else {
        this.derivatives_valid = false;
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [derivatives_valid]
    bufferOffset = _serializer.bool(obj.derivatives_valid, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [derivatives_valid]
    data.derivatives_valid = _deserializer.bool(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.derivatives_valid !== undefined) {
      resolved.derivatives_valid = msg.derivatives_valid;
    }
    else {
      resolved.derivatives_valid = false
    }
